...
public class OrderController {
    ...
    @Operation(summary = "Create new order", description = "Creates a new trading order for the authenticated user")
    @ApiResponses(value = {
    ...
    public ResponseEntity<ApiResponse<List<Order>>> getUserOrders(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Orders retrieved successfully", orders, "/api/orders/user/" + userId));
    }
    ...
    public ResponseEntity<ApiResponse<Order>> cancelOrder(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Order cancelled successfully", cancelledOrder, "/api/orders/" + id + "/cancel"));
    }
}
