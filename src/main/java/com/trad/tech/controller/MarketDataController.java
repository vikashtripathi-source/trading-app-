...
public class MarketDataController {
    ...
    @Operation(summary = "Get market data for symbol", description = "Retrieves current market data for a specific stock symbol")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Market data retrieved successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "404", description = "Symbol not found"),
    ...
    public ResponseEntity<ApiResponse<MarketData>> getMarketData(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Market data retrieved successfully", marketData, "/api/market/data/" + symbol));
    }

    @Operation(summary = "Get batch market data", description = "Retrieves market data for multiple stock symbols")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Market data retrieved successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "400", description = "Invalid symbols"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    ...
    public ResponseEntity<ApiResponse<List<MarketData>>> getBatchMarketData(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Market data retrieved successfully", marketDataList, "/api/market/data/batch"));
    }

    @Operation(summary = "Get market indices", description = "Retrieves major market indices data")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Indices data retrieved successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    @GetMapping("/indices")
    public ResponseEntity<ApiResponse<Object>> getMarketIndices(@RequestHeader("Authorization") String authorization) {
        
        String token = authorization.replace("Bearer ", "");
        authService.validateToken(token); // Validate token
        
        Object indices = marketDataService.getMarketIndices();
        return ResponseEntity.ok(new ApiResponse<>(200, "Indices data retrieved successfully", indices, "/api/market/indices"));
    }

    @Operation(summary = "Get top gainers", description = "Retrieves top gaining stocks")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Top gainers retrieved successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    ...
    public ResponseEntity<ApiResponse<List<MarketData>>> getTopGainers(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Top gainers retrieved successfully", topGainers, "/api/market/top-gainers"));
    }

    @Operation(summary = "Get top losers", description = "Retrieves top losing stocks")
    @ApiResponses(value = {
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Top losers retrieved successfully"),
            @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "401", description = "Unauthorized")
    })
    ...
    public ResponseEntity<ApiResponse<List<MarketData>>> getTopLosers(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Top losers retrieved successfully", topLosers, "/api/market/top-losers"));
    }
    ...
    public ResponseEntity<ApiResponse<List<Object>>> searchSymbols(
        ...
        return ResponseEntity.ok(new ApiResponse<>(200, "Search results retrieved successfully", results, "/api/market/search"));
    }
}
